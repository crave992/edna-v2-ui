...
const SepAreaValidationSchema = Yup.object().shape({
    levelId: Yup.string().required("Class Level is required"),
    name: Yup.string().required("SEP Name is required")
});

export default SepAreaValidationSchema;

export const SepAreaBulkValidationSchema = Yup.object().shape({
