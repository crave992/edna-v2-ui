...
type InPageAction<T> =
    ...
    |
    {
        type: InPageActionType.SHOW_LOADER | InPageActionType.IS_REFRESH_REQUIRED | InPageActionType.SHOW_ADD_UPDATE_MODAL | InPageActionType.SHOW_DELETE_MODAL
        payload: boolean
    }

export const reducer = <T extends {}>(state: InPageState<T>, action: InPageAction<T>) => {
