...
import AddTopic from "@/components/common/LessonMaster/Topic/AddTopic";
...
import BulkUploadTopic from "./BulkUploadTopic";
...
const TopicPage: NextPage<TopicListParams> = (props) => {
