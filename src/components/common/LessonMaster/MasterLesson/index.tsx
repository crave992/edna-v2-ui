...
import AddMasterLesson from "./AddMasterLesson";
import BulkUploadMasterLesson from "./BulkUploadMasterLesson";
import ViewMasterLesson from "./ViewMasterLesson";
...
const MasterLessonPage: NextPage<LessonListParams> = (props) => {
...
export default MasterLessonPage;
