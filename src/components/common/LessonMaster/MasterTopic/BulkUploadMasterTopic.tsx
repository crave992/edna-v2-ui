...
interface BulkUploadMasterTopicProps extends CommonProps {
    isOpen: boolean;
    onClose: (refreshRequired: boolean) => void;
}


const BulkUploadMasterTopic: NextPage<BulkUploadMasterTopicProps> = (props) => {
...
export default BulkUploadMasterTopic;
