...
interface DegreeProps extends CommonProps {
...
const Degree: NextPage<DegreeProps> = (props) => {
    const unitOfService = container.get<IUnitOfService>(TYPES.IUnitOfService);
    const [states, dispatch] = useReducer(reducer<StaffDegreeDto[]>, initialPageState);
    ...
    const deleteDegree = async () => {
        ...
        const response = await unitOfService.StaffDegreeService.delete(states.id);
    ...
    const fetchStaffDegree = async () => {
        ...
        const response = await unitOfService.StaffDegreeService.getAll();
    ...
    return (
        <>
            <div className='db_heading_block'>
                ...
                <Button className="btn_main size_small" onClick={() => openAddUpdateModal(0)}>Add Degree</Button>
            </div>
                                        ...
                                        <td className="text-center">
                                            ...
                                            >
                                                <span
                                                    ...
                                                    onClick={() => openAddUpdateModal(degree.id)}
                                                >
                                                    <FontAwesomeIcon
                                                        icon={faPenToSquare}
                                                        size="1x"
            ...
            {states.showDeleteModal && (
                <ConfirmBox
                    ...
                    onSubmit={deleteDegree}
                    bodyText="Are you sure want to delete this degree?"
                    noButtonText="Cancel"
