...
import AddSepLevel from "@/components/common/SepMaster/SepLevel/AddSepLevel";
...
import BulkUploadSepLevel from "./BulkUploadSepLevel";
...
const SepLevelPage: NextPage<SepLevelListParams> = (props) => {
