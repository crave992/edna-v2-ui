...
import AddSepTopic from "@/components/common/SepMaster/SepTopic/AddSepTopic";
...
import BulkUploadSepTopic from "./BulkUploadSepTopic";
...
const SepTopicPage: NextPage<SepTopicListParams> = (props) => {
