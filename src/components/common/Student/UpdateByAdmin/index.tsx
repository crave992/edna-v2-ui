...
const UpdateStudentByAdmin: NextPage<UpdateStudentPageParams> = ({ student, parentId }) => {
    ...
    const submitData = async (data: StudentModel) => {
        ...
        const response = await unitOfService.StudentService.updateStudentByStudentIdAndParentId(data.id, formData, parentId);
        if (response && response.status === 200 && response.data.data) {
            toast.success("Student bio updated successfully");
            router.push(`/students/info/${student.id}`);
        } else {
                    ...
                    <Row>
                        <Col md={12}>
                            <Form.Group className="mb-3">
                                <Avatar
                                    imageSrc={tempProfilePicture || student.profilePicture}
                                    size={100}
                                    name="croppedImage"
                                    edit={true}
                                />
                        ...
                        {/* <Col md={(student.profilePicture || tempProfilePicture) ? 9 : 12}>
                            <Form.Group className="mb-3">
            ...
            >
                ...
                <div className="formBlock">
                    <Row>
                        ...
                        <h3 className="formBlock-heading mt-3">Enrollment Information</h3>
                        <Col md={12}>
                            <Form.Group className="mb-3">
                        ...
                        <Col md={12}>
                            <FormLabel className="mb-2">
                                <strong>Additional Care Opted:</strong>
                            </FormLabel>
                            <Form.Group className="mb-3">
                                <div>
                                    <Form.Check
...
export default UpdateStudentByAdmin;
